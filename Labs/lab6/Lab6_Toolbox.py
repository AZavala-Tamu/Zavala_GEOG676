...
class GraduatedColorsRenderer:
    def __init__(self):
        ...
        self.description = "create a graduated coored map based on a specific attribute of a layer"
